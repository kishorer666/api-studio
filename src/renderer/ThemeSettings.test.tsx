...
describe('Theme settings', () => {
  ...
  it('slider hidden in light mode then appears auto-dim 0.8 and adjusts value', () => {
    ...
    expect(queryByLabelText('Interface Dimmer')).not.toBeInTheDocument();
    ...
    const range = getByLabelText('Interface Dimmer') as HTMLInputElement;
  ...
  it('resets dim to 0 and hides slider when dark mode disabled', async () => {
    ...
    expect(getByLabelText('Interface Dimmer')).toBeInTheDocument();
    // Disable dark mode
    fireEvent.click(getByLabelText('Dark Mode'));
